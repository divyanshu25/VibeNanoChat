...
class GPTConfig:
    ...
    data_dir_pretrain_parquet: str = "<YOUR_PATH>/divgoyal/fineweb_edu_parquet"

    sft_cache_dir: str = (
        "<YOUR_PATH>/divgoyal/sft_cache"  # Cache dir for SFT datasets
    )
    ...
    chat_core_hf_cache_dir: str = (
        "<YOUR_PATH>/divgoyal/sft_cache"  # HuggingFace cache directory for datasets
    )
