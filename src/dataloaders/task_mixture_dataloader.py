"""
TaskMixture DataLoader for Mid-Training

This module provides a data loader for the TaskMixture dataset, designed for
mid-training GPT-2 models. The loader handles memory-mapped binary files
containing tokenized data and supports distributed training across multiple processes.

The TaskMixture dataset contains tokenized data from SmolTalk, MMLU, and GSM8K,
stored as continuous binary files (train.bin and val.bin) with uint16 dtype.

Example:
    >>> dataloader = TaskMixtureDataloader(
    ...     data_dir="<YOUR_PATH>/divgoyal/nanochat_midtraining_data",
    ...     batch_size=128,
    ...     block_size=1024,
    ...     split="train"
    ... )
...
class TaskMixtureDataloader:
    """
    A data loader for the TaskMixture dataset optimized for mid-training.
    ...
    def __init__(
        ...
        """
        Initialize the TaskMixture data loader.
