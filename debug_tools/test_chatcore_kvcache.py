...
def main():
    ...
    # CONFIGURATION
    # =========================================================================
    checkpoint_path = "<YOUR_PATH>/divgoyal/nanogpt/midtrain_checkpoints/model_checkpoint_global5267_midtraining.pt"
    ...
    try:
        setup_gsm8k_task(
            ...
            tokenizer=tokenizer,
            split="test",
            cache_dir="<YOUR_PATH>/divgoyal/nanochat_midtraining_data",
        )
